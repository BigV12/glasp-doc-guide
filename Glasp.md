# Glaps, a Game Changer to Highlighting
...
- [Glaps, a Game Changer to Highlighting](#glaps-a-game-changer-to-highlighting)
- [Table of Content](#table-of-content)
- [What is Glaps](#what-is-glaps)
...
- [How to use Glaps](#how-to-use-glaps)
...
![Highlighted article with Glaps](<Screenshot%20(150).png>)
...
![Tag feature](tag.jpg)
Glasp has a tag feature which you can use to arrange and group your highlight into different categories. This helps you to arrange your highlights better for easy access at a later time.

### View other's Highlights

![Glaps like a social media ](<Screenshot%20(135).png>)
Glasp is like a social media platform. But instead of sharing thoughts and opinions, your highlighted texts are shared with all. This means that the text and videos you highlight are not private. It can be seen by every Glasp user who either follows you or searches for your profile.

You can follow different people too and see their highlights.

Comments are allowed about each highlight and people can share their thought.
...
Glasp is a web browser extension. it works only on Safari and Google Chrome for now. To install Glaps on your browser, you need to go to your web browser store and Install it.
...
After pinning it, the Glasp icon will always be on your browser. Whenever you visit a page that you can Glasp text from.

![Alt text](ginstall.jpg)

The icon will be visible but when you visit a page you can't Glasp, it will show an off sign.
![Glasp Limitations](<Screenshot%20(47)_LI.jpg>)
...
2. Highlight the text that intrests You. You will see a 4 colour button hover the text you highlighted.
...
For each highlight, on the right panel, you would see the title of the article, the link, the tag you gave to it, and your thoughts and comments about the highlight and the highlighted texts.
...
This is a begginer friendly introduction to Glasp and how to useit. It was written for those who are just hearing about Glasp for the first time and want to know more about the softare and how to use it.
